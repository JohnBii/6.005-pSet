...
public class ComplexNumber {
	...
	public static double[] getPolarForm(ComplexNumber c) {
		 ...
		 */
		double real = c.getRealVal();
		
		// Find radius
		double r = 0.0; //replace 0.0 with 
						//expr that calculates the radius
		// Find angle
		double angle = 0.0; // same story as above
	...
	public static ComplexNumber complexConjugate(ComplexNumber c){
		...
		// Negative of imaginary part
		return new ComplexNumber(c.getRealVal(), -c.getImgVal());
	}
