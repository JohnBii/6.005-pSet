...
public class Date {
	...
	/**
	 * Constructs a Date object given a date mm/dd/yyy
	 * 
	 * @param date - a String representing the date as mm/dd/yyy
	 */
	public Date(String date) {
		String [] mdy = date.split("/");
		this.YEAR = Integer.parseInt(mdy[2]);
		this.MONTH = getMonth(Integer.parseInt(mdy[0]));
		this.DAY_NUM = Integer.parseInt(mdy[1]);
		this.DAY = getDay(YEAR, MONTH, DAY_NUM);
	}
